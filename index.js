...
// ✅ Database connection import করুন (optional but good practice)
...
const selectedClassRoutes = require('./routes/selectedClassRoutes');
...
app.use(
  cors({
    origin: ['http://localhost:5173', 'https://language-center-bedfd.web.app'],
    credentials: true,
  })
);
...
app.use('/api/selectedClass', selectedClassRoutes);
app.use('/api/getSelectedClass', selectedClassRoutes);
...
async function startServer() {
  try {
    await connectDB(); // ✅ Database connect করুন
    app.listen(port, () => {
